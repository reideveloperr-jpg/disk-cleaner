...
const QHash<QString, QString>& uk_table()
{
    static const QHash<QString, QString> t = {
        ...
        // Recent view
        { "Files and folders created within the chosen window.",
                                                "Файли та папки, створені у вибраному вікні." },
        { "Last N days",                        "За останні N днів" },
        { "Date range",                         "Діапазон дат" },
        { "Search by name or path",             "Пошук за іменем або шляхом" },
        { "Window:",                            "Вікно:" },
        { "Custom — number of days:",           "Своє — кількість днів:" },
        { "Apply",                              "Застосувати" },
        { "From:",                              "Від:" },
        { "To:",                                "До:" },
        { "Today",                              "Сьогодні" },
        ...
        { "Folder",                             "Папка" },
        { "File",                               "Файл" },
        { "Showing %1 of %2 entries · %3",      "Показано %1 з %2 · %3" },
